...
-- Trigger for updating update_time in personas
CREATE TRIGGER IF NOT EXISTS tr_personas_update_time
AFTER UPDATE ON personas
BEGIN
    UPDATE personas SET update_time = CURRENT_TIMESTAMP WHERE id = OLD.id;
END;
...
INSERT INTO personas (name, description, system_prompt, is_preset) VALUES 
